...
function integralEvaluation (N, a, b, func, coverage) {
  ...
  let temp
  for (let i = 0; i < N + 1; i++) {
    if (i === 0) { coverage[6] = true; temp = func(xi) } else if (i === N) { coverage[7] = true; temp = func(xi) } else if (i % 2 === 0) { coverage[8] = true; temp = 2 * func(xi) } else { coverage[9] = true; temp = 4 * func(xi) }
